    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', edc_base.model.fields.uuid_auto_field.UUIDAutoField(blank=True, db_index=True, editable=False, help_text='System auto field. UUID primary key.')),
                ('slug', models.CharField(db_index=True, editable=False, help_text='a field used for quick search', max_length=250, null=True)),
                ('manifest_identifier', models.CharField(db_index=True, default=edc_lab.model_mixins.manifest_model_mixin.timestamp, max_length=25, verbose_name='Manifest Identifier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', edc_base.model.fields.uuid_auto_field.UUIDAutoField(blank=True, editable=False, help_text='System auto field. UUID primary key.', primary_key=True, serialize=False)),
                ('slug', models.CharField(db_index=True, editable=False, help_text='a field used for quick search', max_length=250, null=True)),
                ('manifest_identifier', models.CharField(default=edc_lab.model_mixins.manifest_model_mixin.timestamp, max_length=25, unique=True, verbose_name='Manifest Identifier')),
                ('manifest_datetime', models.DateTimeField(default=django.utils.timezone.now)),
                ('comment', models.TextField(null=True, verbose_name='Comment')),
                ('shipped', models.BooleanField(default=False)),
                ('destination', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='edc_lab.Destination', verbose_name='Ship to')),
            ],
            options={
