# -*- coding: utf-8 -*-
#
# lab_clinic_api documentation build configuration file, created by
...
htmlhelp_basename = 'lab_clinic_apidoc'
...
latex_documents = [
  ('index', 'lab_clinic_api.tex', u'bhp\\_crypto Documentation',
...
man_pages = [
    ('index', 'lab_clinic_api', u'lab_clinic_api Documentation',
...
texinfo_documents = [
  ('index', 'lab_clinic_api', u'lab_clinic_api Documentation',
   u'erik van widenfelt', 'lab_clinic_api', 'One line description of project.',
   'Miscellaneous'),
]
